...
class AddPoint extends Component {
    ...
    estados = {
        listaArray:[ 'Acre','Alagoas','Amapá','Amazonas','Bahia','Ceará','Distrito Federal','Espírito Santo',
    ...
    salvar(e){
        ...
        e.preventDefault();
        let ponto = {nome: this.state.nome, estado: this.state.estado, cidade: this.state.cidade, referencia: this.state.referencia, 
            descricao: this.state.descricao, data };
            ...
            <div>
                ...
                <div className="container ">
                      ...
                      <div className="card col-md-6 offset-md offset-md-3 ">
                            <h3 className="text-center"><img className="imagem2" src="/images/logo2.png" alt=""/>Adicionar Ponto Turístico</h3>
                            <div className="card-body">
                                <form>
                                    <div className="form-group">
                                        <label>Nome</label>
                                        <input placeholder="Nome do Ponto Turístico" name="nome" className="form-control" 
                                            value={this.state.nome} onChange={this.changeNameHandler}/>
                                    </div>
                                    <div>
                                        <h6><b>Localização</b></h6>
                                    </div>
                                    
                                    <div className ="container p-0">
                                    <label>Estados</label>
                                        <select className="custom-select" value={this.state.estado} onChange={this.changeEstadoHandler}>
                                    ...
                                    <label>Referência</label>
                                        <input placeholder="Referencia" name="referencia" className="form-control" 
                                            value={this.state.referencia} onChange={this.changeReferenciaHandler}/>
                                    </div>
                                    <div>
                                       <label for="detalhes">Descrição</label>
                                          <textarea class="form-control" id="detalhes" rows="3"
